        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-stone-200 mb-6 max-w-md">
              A community of like-minded individuals who value growth, curiosity, and empowerment. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/blog?category=marketing" className="text-stone-200 hover:text-white transition-colors">Marketing</Link></li>
              <li><Link href="/blog?category=travel" className="text-stone-200 hover:text-white transition-colors">Travel</Link></li>
              <li><Link href="/blog?category=technology" className="text-stone-200 hover:text-white transition-colors">Technology</Link></li>
              <li><Link href="/blog?category=wellness" className="text-stone-200 hover:text-white transition-colors">Wellness</Link></li>
            </ul>
          </div>
        </div>
